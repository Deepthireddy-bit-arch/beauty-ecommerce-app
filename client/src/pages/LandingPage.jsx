...
//   .lp-inner { padding-left: 20px; padding-right: 20px; }

//   /* Hero */
//   .lp-hero__label { font-size: 9px; letter-spacing: 2px; margin-bottom: 10px; }
//   .lp-hero__title { font-size: clamp(2rem, 9vw, 2.8rem); margin-bottom: 12px; }
//   .lp-hero__content { padding-bottom: 56px; }
//   .lp-hero__text .btn-purple { padding: 11px 24px; font-size: 12px; }
//   .lp-hero__dots { bottom: 20px; }

//   /* Brand strip */
//   .lp-strip__track { gap: 32px; }
//   .lp-strip__item { font-size: 9px; letter-spacing: 2px; }

//   /* Section headers */
//   .lp-sec-head { margin-bottom: 32px; }
//   .lp-sec-head h2 { font-size: clamp(1.5rem, 7vw, 2rem); }
//   .lp-sec-head p { font-size: 13px; }

//   /* Luxe brands — skeleton was fixed 3-col even on tiny screens */
//   .lp-brands { padding: 40px 0; }
//   .lp-brands__hd { margin-bottom: 24px; }
//   .lp-brands__title { font-size: 1.5rem; }
//   .lp-brands__sk-grid { grid-template-columns: 1fr; grid-template-rows: none; }
//   .lp-brands__sk-hero { grid-row: auto; min-height: 200px; }

//   /* View-all buttons — stop them being tiny/off-center on mobile */
//   .lp-viewall { width: 100%; justify-content: center; padding: 11px 20px; }

//   /* Top brands carousel */
//   .lp-tbc { padding: 48px 0; }
//   .lp-tbc__title { font-size: 1.5rem; }
//   .lp-tbc__hd { gap: 14px; }
//   .lp-tbc__arrow { width: 34px; height: 34px; font-size: 16px; }

//   /* Products */
//   .lp-products { padding: 56px 0; }
//   .lp-products__cats { gap: 8px; margin-bottom: 28px; }
//   .lp-cat-btn { padding: 8px 16px; font-size: 11px; }
//   .lp-pcard__img { height: 150px; }
//   .lp-pcard__body { padding: 12px 14px 16px; }
//   .lp-pcard__name { font-size: 14px; }
//   .lp-pcard__price { font-size: 18px; }

//   /* Category banners */
//   .lp-catbanner { padding: 56px 0; }
//   .lp-catbanner__body { padding: 20px; }
//   .lp-catbanner__offer { font-size: 1.4rem; }

//   /* Shoppable reels */
//   .lp-reels { padding: 56px 0; }
//   .lp-reels__hd { margin-bottom: 28px; }
//   .lp-reels__grid { gap: 10px; }

//   /* Stats band — numbers were still 30px, cramped in 2 cols */
//   .lp-stats { padding: 40px 0; }
//   .lp-stats__num { font-size: 26px; }
//   .lp-stats__label { font-size: 13px; }
//   .lp-stats__sub { font-size: 11px; }

//   /* Features */
//   .lp-features__item { padding: 28px 20px; }
//   .lp-features__title { font-size: 16px; }
//   .lp-features__desc { font-size: 12.5px; }

//   /* Testimonials */
//   .lp-reviews { padding: 56px 0; }
//   .lp-review { padding: 24px 22px; }
//   .lp-review__quote { font-size: 52px; top: 16px; right: 18px; }

//   /* Newsletter */
//   .lp-nl { padding: 56px 0; }
//   .lp-nl__deco { font-size: 70px; }
//   .lp-nl__title { font-size: 1.6rem; }
// }
// `;
...
/* ═══════════════════════════════════════════════════════
   MOBILE FIX — Hero video / Top Brands / Shoppable Reels
   (≤ 480px) — placed last so it wins over earlier mobile rules
═══════════════════════════════════════════════════════ */
@media (max-width: 480px) {

  /* ── HERO VIDEO ── */
  .lp-hero { height: 88vh; min-height: 460px; }
  .lp-hero__media { object-position: center; }
  .lp-hero__overlay {
    background: linear-gradient(
      180deg,
  ...
  .lp-hero__content { padding-bottom: 64px; }
  .lp-hero__label { font-size: 9.5px; letter-spacing: 2px; margin-bottom: 10px; }
  .lp-hero__title { font-size: clamp(2rem, 8.5vw, 2.6rem); margin-bottom: 10px; }
  .lp-hero__sub {
    display: -webkit-box;
    font-size: 12.5px;
    line-height: 1.6;
  ...
  .lp-hero__text .btn-purple { padding: 12px 26px; font-size: 12px; width: fit-content; }
  .lp-hero__dots { bottom: 18px; }
  .lp-hero__dot { height: 6px; }

  /* ── TOP BRANDS ON OFFER ── */
  .lp-tbc { padding: 44px 0; }
  .lp-tbc__hd { margin-bottom: 24px; }
  .lp-tbc__title { font-size: 1.4rem; }
  .lp-tbc__arrows { display: none; }
  .lp-tbc__track-wrap { overflow-x: auto; scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch; }
  .lp-tbc__track-wrap::-webkit-scrollbar { display: none; }
  .lp-tbc__track { transform: none !important; gap: 14px; padding-bottom: 4px; }
  .lp-tbc__card {
    flex: 0 0 62%;
    scroll-snap-align: start;
  }
  .lp-tbc__card-img { height: 150px; }
  .lp-tbc__card-body { padding: 14px 16px 18px; }
  .lp-tbc__card-name { font-size: 14px; }
  .lp-tbc__card-sub { font-size: 11px; margin-bottom: 10px; }
  .lp-tbc__card-btn { padding: 7px 16px; font-size: 11px; }
  .lp-tbc__dots { display: none; }
  .lp-tbc__sk { grid-template-columns: 1fr 1fr; gap: 14px; }
  .lp-tbc__sk-img { height: 130px; }

  /* ── SHOPPABLE REELS (video cards) ── */
  .lp-reels { padding: 48px 0; }
  .lp-reels__hd { margin-bottom: 24px; flex-direction: column; align-items: flex-start; gap: 12px; }
  .lp-reels__hd h2 { font-size: 1.7rem !important; }
  .lp-reels__hd p { font-size: 12.5px !important; }
  .lp-viewall--ghost { width: 100%; justify-content: center; }
  .lp-reels__grid {
    display: flex;
    overflow-x: auto;
  ...
  .lp-reels__grid::-webkit-scrollbar { display: none; }
  .lp-reels__card { flex: 0 0 68%; scroll-snap-align: start; }
  .lp-reels__card-img { height: 340px; }
}
`;
