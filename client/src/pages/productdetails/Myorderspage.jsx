...
//   return (
//     <div style={{ maxWidth: 1260, margin: '0 auto', padding: '0 0 4rem', fontFamily: 'inherit' }}>
//       <OrdersGlobalStyles />
...
//       {/* Toolbar — only shown when there are orders */}
...
//       {/* Status filter pills (visual shortcut) */}
//       {!loading && myOrders.length > 0 && (
...
// MyOrdersPage.jsx — padding now driven by --nav-pad-x via MyOrders.css
import React, { useEffect, useMemo, useState, useCallback } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';
import { getMyOrders } from '../../redux/reducers/thunks/orderThunks';
